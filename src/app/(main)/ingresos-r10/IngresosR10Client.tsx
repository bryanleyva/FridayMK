                ...
                <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                    ...
                    <div>
                        ...
                        <p style={{ color: '#6b7280', fontSize: '0.8rem', margin: '0.25rem 0 0' }}>
                            Ventas cerradas · {totalVentas} {totalVentas === 1 ? 'venta' : 'ventas'} · {totalLineas} {totalLineas === 1 ? 'línea' : 'líneas'}
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem' }}>
                            <thead>
                                <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
                                    {['ID', 'Fecha cierre', 'Cliente', 'RUC/DNI', 'Canal', 'Entrega', 'Líneas', 'Ejecutivo'].map(h => (
                ...
                <div style={{ padding: '1.5rem 2rem', borderBottom: '1px solid rgba(255,255,255,0.06)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.25rem' }}>
                            ...
                            <span style={{ background: 'rgba(16,185,129,0.15)', color: '#10b981', padding: '0.1rem 0.6rem', borderRadius: '999px', fontSize: '0.7rem', fontWeight: 700 }}>CERRADO</span>
                        </div>
